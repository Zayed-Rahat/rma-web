    ...
    <div class="fix container">
        ...
        <div class="row our_services_footer_four_images">
            <div class="col-md-6 cc">
                <img src="/ast/img/cc.png" class="img_cc img-fluid" alt=""/>
                <div class="cc_wraper">
            ...
            <div class="col-md-3 pm_div">
                <div class="pm_wrapper">
                    <img src="/ast/img/pm.png" class="img_pm img_pm1 img-fluid" alt=""/>
                    <div class="pm">
                        <h5 class="pm_h pm_h1">Project <br/> Making</h5>
                    </div>
                </div>
                <div class="pm_wrapper dd">
                    <img src="/ast/img/dd.png" class="img_pm img_dd img-fluid" alt=""/>
                    <div class="pm">
